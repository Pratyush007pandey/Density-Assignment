        ...
        <div className="flex flex-1 flex-col  ">
          ...
          >
            <div className="flex flex-[0.7] flex-col md:px-6 px-4 py-4 ">
              ...
              <p className="text-start text-[#535353] font-semibold">
                At ahead our goal is to make self-improvement dun and lasting.
            ...
            <div className="flex flex-[0.3] flex-col p-2 bg-[#FEF6F0] rounded-3xl gap-1 md:px-6 px-4 py-4">
              ...
              <p className="text-start text-[#535353] font-semibold mb-3">
        ...
        >
          <div className="flex items-center md:justify-end justify-center">
            <motion.h1
              ...
              whileInView={{ x: 0, scale: 1, opacity: 1 }}
              viewport={{ once: true }}
              className="md:text-4xl text-3xl text-[#6B4DEE] md:text-end text-center font-bold"
            >
              ahead
            </motion.h1>
          </div>
